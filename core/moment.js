! function(e, t) {
    ...
    n.createFromInputFallback = k("value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to core Date(), which is not reliable across all browsers and versions. Non RFC2822/ISO date formats are discouraged and will be removed in an upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/core-date/ for more info.", function(e) {
    ...
    return In.isValid = function() {
        ...
        n._d = new Date(M(e))
    }), n.version = "2.22.2", e = Tt, n.fn = ln, n.min = function() {
